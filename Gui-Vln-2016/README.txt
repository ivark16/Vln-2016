Hello, welcome to the Help window!
This program gives the user access to a database. 
The user can view and edit the database in various ways.
...
To play or pause the music the user has to push the Play music checkbox on the bottom of the page to the left.  The music playing in the background is Disco House by Bernhard Kosten.  The song can be found here: http://www.flashkit.com/loops/Easy_Listening/discohouse-140130084506.html 
