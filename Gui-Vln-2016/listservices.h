...
public:
    ...
    //Functions to search if and when a computer was built.
    ...
    //Functions to check for Turing Awards.
    vector<Scientist> checkForAward(int x);

    //Functions that check for birth and death year.
    ...
    //Search functions for scientist by ID to display picture.
